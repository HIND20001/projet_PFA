...
class Offre(models.Model):
    Recruteur = models.ForeignKey(
        Recruteur, on_delete=models.CASCADE, default='1')
    ...
    experience_requete = models.CharField(max_length=180, default='null')
    ...
    Specialite = models.ForeignKey(
        Specialite, on_delete=models.CASCADE, default=None)
...
class Candidature(models.Model):
    ...
    Dernier_post_occupe = models.CharField(max_length=180, default='null')
